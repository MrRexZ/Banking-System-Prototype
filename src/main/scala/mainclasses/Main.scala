...
import scalafx.application.JFXApp.PrimaryStage
import scalafx.scene.Scene
import mainclasses.util.ResourceLoading._
...
object Main extends JFXApp{
  ...
  user += new User("D_dd","457","Sam","Pinkerton","42 Kenley Rd, Kingston upon Thames, Greater London KT1 3RS, UK","+44 3069 990447","M","1990-01-02","United Kingdom","4",1500,0)
  user += new User("D_dd","457","Sat","Pinkerton","42 Kenley Rd, Kingston upon Thames, Greater London KT1 3RS, UK","+44 3069 990447","M","1990-01-02","United Kingdom","5",1500,0)
 ...
 val registrationpagelayout="/registrationform.fxml".loadFXML();
 ...
 val userloader="/userpage.fxml".loadFXML();    
 ...
 val adminloader = "/adminpage.fxml".loadFXML();  
 ...
 val mainlayout = "/mainpage.fxml".loadFXML(); 
 val mainpage=mainlayout.getRoot[javafx.scene.layout.AnchorPane]
 
 val rootlayout="/RootLayout.fxml".loadFXML();
